use ratatoskr_core::{FileTreeEntry, GraphData, GraphStats};
...
#[tauri::command]
fn list_directory(directory: String, show_hidden: bool) -> Result<Vec<FileTreeEntry>, String> {
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![load_graph, save_graph, get_graph_stats, generate_sample_graph, list_directory])
